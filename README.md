    ...
    "prompts": [
        {
            ...
            "post_flow": diff between current prompt index and target prompt if commit fails,
            ...
            "permit_end": if model can end, if the model decide to not end the 'post_flow' is applied
        }
        ...
    ]
}
