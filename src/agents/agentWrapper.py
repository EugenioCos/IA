...
class AgentWrapper:
    ...
    def read_agent_dict(self, agent_dict: dict):
        ...
        self.can_read: bool = bool(agent_dict.get("can_read"))
        self.can_write: bool = bool(agent_dict.get("can_write"))
        self.can_commit: bool = bool(agent_dict.get("can_commit"))
        self.can_decide: bool = bool(agent_dict.get("can_decide"))
